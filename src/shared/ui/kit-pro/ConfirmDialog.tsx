...
import { Avatar, Button, Dialog } from '@/shared/ui/kit'
import type { DialogProps, ButtonProps } from '@/shared/ui/kit'
...
const StatusIcon = ({ status }: { status: StatusType }) => {
    switch (status) {
        case 'info':
            return (
                <Avatar
                    className="bg-blue-100 text-blue-600 dark:bg-blue-600/20 dark:text-blue-100"
                    shape="circle"
                >
        ...
        case 'success':
            return (
                <Avatar
                    className="bg-emerald-100 text-emerald-600 dark:bg-emerald-600/20 dark:text-emerald-100"
                    shape="circle"
                >
                    <span className="text-2xl">
                        <HiCheckCircle />
